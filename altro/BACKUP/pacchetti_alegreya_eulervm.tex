...
\usepackage[utf8]{inputenc} % Consente l'uso caratteri accentati italiani
\linespread{1.11} % Line spacing - Palatino needs more space between lines
\usepackage{amsmath, amsthm, amssymb, amsfonts}
\usepackage[italian]{babel}
\usepackage[kerning,spacing,tracking,letterspace = 3,babel]{microtype} % Slightly tweak font spacing for aesthetics. Il tre è pensato per Alegreya

%\SetTracking[no ligatures = f]{encoding = *,shape = *}{300} % Aumenta la distanza fra le lettere
...
\usepackage{tabulary}		% Tabelle migliorate che vanno a capo da sole...
\usepackage{gnuplot-lua-tikz}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[hmargin=0.18\paperwidth,% metti la larghezza del testo (margini orizzontali) al 18% del foglio
	    hmarginratio=1:1,       % margini destro e sinistro uguali
	    top=32mm,	            % margine sopra a 32mm...
	    vmarginratio=1:1,       % quello sotto uguale (default 2:3)
